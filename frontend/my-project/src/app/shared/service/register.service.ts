...
readonly APIResume="https://localhost:5001/api/Resume";
  ...
  getcompanyallreports(val:any)
  {
    
    return this.http.post<any>(this.APIResume+'/GetCompanyReport',val);
  }
  ...
  getadmindata(val:any)
  {
    console.log("Admin Session:="+val);
    return this.http.post(this.APIUrl+'/GetAdminData',val);
  }
  ...
  deactivecompany(val:any){

    console.log("Service:-"+val);
    return this.http.post(this.APIUrl+'/DeactiveCompany',val);
  }
